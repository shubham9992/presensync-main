...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter usename", placeholder="shubhampatil")
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder="shubhampatil")
    teacher_name = st.text_input("Enter name", placeholder="Shubham Patil")
    teacher_password = st.text_input("Enter password", type="password", placeholder="Enter password")
    teacher_password_confirm = st.text_input("Confirm your password", type="password", placeholder="Confirm your password")
