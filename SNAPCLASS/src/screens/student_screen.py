...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder="Ex. Shubham Patil")
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like I'm present, My name is Shubham.")
            except Exception:
